...
$coursepresentation = theme_hurix_get_setting('coursepresentation');
...
if (!$coursepresentation || $coursepresentation == 1) {
    echo $OUTPUT->render_from_template('theme_hurix/columns2', $templatecontext);
} else if ($coursepresentation == 2) {
    echo $OUTPUT->render_from_template('theme_hurix/course_cover', $templatecontext);
}
