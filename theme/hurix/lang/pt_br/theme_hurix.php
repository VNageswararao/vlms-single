...
$string['choosereadme'] = 'hurix é um tema moderno e altamente customizável. Este tema tem por objetivo ser usado diretamente, ou como um tema pai quando criados novos temas utilizando Bootstrap 4.';
...
$string['cachedef_fontawesomehurixiconmapping'] = 'Definição de cache dos ícones do tema';
...
$string['privacy:metadata:preference:themehurixsettings_fonttype'] = 'Preferências do usuário para tipo de fonte.';
$string['privacy:metadata:preference:themehurixsettings_enableaccessibilitytoolbar'] = 'Preferências do usuário para habilitar a barra de acessibilidade.';
...
$string['privacy:themehurixsettings_fonttype'] = 'A preferência atual para o tipo de fonte é: {$a}.';
$string['privacy:themehurixsettings_enableaccessibilitytoolbar'] = 'A preferência atual para habilitar a barra de acessibilidade é para exibi-lá';
