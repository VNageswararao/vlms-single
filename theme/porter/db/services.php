...
/**
 * Theme porter functions and service definitions.
 *
...
$functions = array(
    'theme_porter_fontsize' => array(
        'classname' => 'theme_porter\api\accessibility',
        'classpath' => 'theme_porter/classes/api/accessibility.php',
        'methodname' => 'fontsize',
        'description' => 'Increase or decrease the site font size.',
        'type' => 'write',
        'ajax' => true
    ),
    'theme_porter_sitecolor' => array(
        'classname' => 'theme_porter\api\accessibility',
    ...
    'theme_porter_savethemesettings' => array(
        'classname' => 'theme_porter\api\accessibility',
    ...
    'theme_porter_getthemesettings' => array(
        'classname' => 'theme_porter\api\accessibility',
