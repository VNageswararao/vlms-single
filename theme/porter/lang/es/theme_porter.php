...
$string['choosereadme'] = 'porter es un tema moderno altamente personalizable. Este tema está destinado a ser utilizado directamente o como tema principal al crear nuevos temas utilizando Bootstrap 4.';
...
$string['cachedef_fontawesomeportericonmapping'] = 'Definición de fuente de icono de tema';
...
$string['privacy:metadata:preference:themeportersettings_fonttype'] = 'The user\'s preference for font type.';
$string['privacy:metadata:preference:themeportersettings_enableaccessibilitytoolbar'] = 'The user\'s preference for enable the accessibility toolbar.';
...
$string['privacy:themeportersettings_fonttype'] = 'The current preference for the font type is: {$a}.';
$string['privacy:themeportersettings_enableaccessibilitytoolbar'] = 'The current preference for enable accessibility toolbar is to show it.';
