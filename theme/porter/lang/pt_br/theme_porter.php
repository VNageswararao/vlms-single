...
$string['pluginname'] = 'porter';
$string['configtitle'] = 'porter';
$string['choosereadme'] = 'porter é um tema moderno e altamente customizável. Este tema tem por objetivo ser usado diretamente, ou como um tema pai quando criados novos temas utilizando Bootstrap 4.';
...
$string['cachedef_fontawesomeportericonmapping'] = 'Definição de cache dos ícones do tema';
...
$string['privacy:metadata:preference:themeportersettings_fonttype'] = 'Preferências do usuário para tipo de fonte.';
$string['privacy:metadata:preference:themeportersettings_enableaccessibilitytoolbar'] = 'Preferências do usuário para habilitar a barra de acessibilidade.';
...
$string['privacy:themeportersettings_fonttype'] = 'A preferência atual para o tipo de fonte é: {$a}.';
$string['privacy:themeportersettings_enableaccessibilitytoolbar'] = 'A preferência atual para habilitar a barra de acessibilidade é para exibi-lá';
