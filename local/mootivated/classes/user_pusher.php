...
class user_pusher {
    ...
    public function push_chunk() {
        ...
        $sql = "SELECT DISTINCT u.id, u.username, u.firstname, u.lastname, u.email, u.deleted, u.suspended, u.confirmed,
                                ra.id as roleassignmentid
        ...
        foreach ($records as $user) {
            ...
            // Check whether the user is deleted, suspended, or unconfirmed.
