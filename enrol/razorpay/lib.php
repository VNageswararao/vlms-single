...
class enrol_razorpay_plugin extends enrol_plugin {
    ...
    public function get_currencies() {
        ...
        // 3-character ISO-4217: https://cms.razorpay.com/us/cgi-bin/?cmd=_render-content&content_ID=developer/e_howto_api_currency_codes
        $codes = array(
    ...
    public function edit_instance_form($instance, MoodleQuickForm $mform, $context) {
        ...
        $razorpaycurrencies = $this->get_currencies();
        $mform->addElement('select', 'currency', get_string('currency', 'enrol_razorpay'), $razorpaycurrencies);
    ...
    public function can_delete_instance($instance) {
        ...
        return has_capability('enrol/razorpay:config', $context);
    }
