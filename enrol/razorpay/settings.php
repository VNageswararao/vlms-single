...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('enrol_razorpay/razorpayemail', get_string('email', 'enrol_razorpay'), get_string('businessemail_desc', 'enrol_razorpay'), '', PARAM_EMAIL));

    
    $settings->add(new admin_setting_configtext('enrol_razorpay/key_id', get_string('key_id', 'enrol_razorpay'),'', PARAM_TEXT));

    $settings->add(new admin_setting_configtext('enrol_razorpay/key_secret', get_string('key_secret', 'enrol_razorpay'),'', PARAM_TEXT));
