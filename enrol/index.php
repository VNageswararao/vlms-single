...
$payementGateways=array('razorpay');
foreach($enrolinstances as $k=>$v){
if(in_array($v->enrol,$payementGateways)){
    $paymentGatewaysEnable=false;
    break;
}
}
//echo"<pre>";print_r($enrolinstances);die;
if (!isloggedin() && $paymentGatewaysEnable) {
