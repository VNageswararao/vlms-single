...
function is_manager($userid = null) {
    ...
    $role = user_has_role_assignment($userid, 1);
    if ($role) {
        $ismanger = true;
    } else {
        $ismanger = false;
...
function is_student($userid = null) {
    global $USER;
    if (empty($userid)) {
        $userid = $USER->id;
    }
    $role = user_has_role_assignment($userid, 5);
    if ($role) {
        $isstudent = true;
    } else {
        $isstudent = false;
...
function is_teacher($userid = null) {
    global $USER;
    if (empty($userid)) {
        $userid = $USER->id;
    }
    $role = user_has_role_assignment($userid, 3);
    if ($role) {
        $isteacher = true;
    } else {
        $isteacher = false;
